...
public class Product {
    ...
    //Itemsはそれぞれの宣言されているIDに依存んしているため、IDは同じ場合は、Itemも同じと設定する。
    //このために、returnは下記通りに書く。"equals"は、Stringでの比較を表している。
    //Itemは同じ場合は、OldItemとNewItemのTRUEをreturnする。同じじゃない場合は、FALSE。
    public static DiffUtil.ItemCallback<Product> itemCallback = new DiffUtil.ItemCallback<Product>() {
        ...
        //上記のboolean methodのequalsで、oldItem=newItemをreturnする
        @Override
